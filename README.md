...
## Build With Singapore Market Data

Kun Data provides a token-authenticated API stack for developers who need Singapore market data in products that must load fast, stream live prices, and support charting or screening workflows.

This repository is focused on Singapore coverage with support for SGX and is designed for teams building broker dashboards, watchlists, quant tools, stock screeners, mobile apps, and market overview pages.

## Common Integration Needs

Most teams integrating market data need one or more of these capabilities:

- Real-time Singapore stock market API
...
### Does this support real-time Singapore market data?
...
If you need Singapore market data coverage for SGX, start with the product page and documentation:
