...
public class Main {
    ...
    private static final String MARKET = "SG";
    private static final String EXCHANGE = "SGX";
    private static final String SYMBOL = "SGX:000040";
                ...
                .buildAsync(URI.create(WS_URL), new WebSocket.Listener() {
                    ...
                    public void onOpen(WebSocket webSocket) {
                        String subscribeJson = "{\"action\":\"subscribe\",\"market\":\"" + MARKET
                                + "\",\"exchange\":\"" + EXCHANGE
                                + "\",\"symbols\":[\"SGX:000040\",\"SGX:005930\"],\"replay\":\"last\"}";
